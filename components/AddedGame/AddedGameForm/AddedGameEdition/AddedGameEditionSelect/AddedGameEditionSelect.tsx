...
export function AddedGameEditionSelect ({packages, funcs, editionError}: TAddedGameEditionSelect) {
  return (
    <div className={styles.container}>
      <h3 className={styles.title}>
        Издание
        {editionError.activate ? <span className={styles.error}>{editionError.errorMessage}</span> : ""}
      </h3>
